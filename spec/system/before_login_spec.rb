...
describe '[STEP1] ユーザログイン前のテスト' do
  ...
  describe 'ヘッダーのテスト: ログインしていない場合' do
    ...
    context '表示内容の確認' do
      ...
      it 'loginリンクが表示される: 左上から5番目のリンクが「log in」である' do
  ...
  describe 'ユーザ新規登録のテスト' do
    ...
    context '表示内容の確認' do
      ...
      it 'kana_nameフォームが表示される' do
        expect(page).to have_field 'user[kana_name]'
      end
    ...
    # チェック済み name,kana_nameのfaker確認
    context '新規登録成功のテスト' do
      before do
        fill_in 'user[name]'
        fill_in 'user[kana_name]'
